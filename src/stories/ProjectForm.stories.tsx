...
import { Card, Flex, Heading, Text, TextField, Select, Switch, Button, Separator } from '@radix-ui/themes';
  ...
  render: () => (
    <Card style={{ maxWidth: 420 }}>
      <Flex direction="column" gap="4" p="2">
        ...
        <Text as="label" size="2"><Flex gap="2" align="center"><Switch defaultChecked /> Notify collaborators</Flex></Text>
        <Separator size="4" />
